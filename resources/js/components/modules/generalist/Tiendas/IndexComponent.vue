        ...
        <div class="padding  pt-4">
            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="" v-if="form.buscar_tienda == ''" >
                    ...
                    <div class="" v-if="filtro_regional != '' ">
                        <pagination class="d-flex justify-content-center" :data="lista_charges" @pagination-change-page="getTiendas">
                            <span slot="prev-nav">ANTERIOR</span>
                            <span slot="next-nav">SIGUIENTE</span>
                        </pagination>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            getCharges(page=1){
                this.lista_charges={};
                axios.get('/generalist/getdatatiendas?page='+page)
                .then((res) => { 
                    // this.lista_charges={}  
            ...
            getTiendas(page=1){
                if (this.filtro_regional == "") {
                    ...
                    this.lista_charges={};
                    axios.get('/generalist/getdatatiendas2/'+this.filtro_regional+'?page='+page)
                    .then((res) => { 
                        // this.lista_charges={}  
                        this.lista_charges = Object.assign(res.data.tiendas, {});
                        this.regionales = Object.assign(res.data.regionals, {});
            ...
            deleteCharge(id){
                ...
                if (result.isConfirmed) {
                    axios.delete(`/generalist/deletetienda/${id}`)
                    .then((res) => {
            ...
            search(){
                if (this.form.buscar_tienda == '') {
                    ...
                    axios.post('/generalist/store/search',this.form)
                    .then((res) => {
                        this.lista_charges = {},
