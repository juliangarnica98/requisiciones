        ...
        <nav class="sidebar">
            ...
            <div class="menu-bar">
                <div class="menu">
                    ...
                    <div class="pt-5"></div>
                    <ul v-if="area =='1' || area =='5' || area =='3' || area =='4' || area == '2' "  class="menu-links ">
                        ...
                        <li class="nav-link">
                            ...
                            >
                                ...
                                <span v-if="area =='1'" class="text nav-text"
                                    >REGIONAL</span
                                >
                                <span v-if="area =='2'" class="text nav-text"
                                    >GERENCIA</span
                                >
                    ...
                    <ul class="menu-links">
                        <li class="nav-link">
                            <router-link class="router-link" to="/director/crear-requisicion" aria-expanded="false" >
