      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" >
          <div class="modal-body">
              ...
              <div>
                  <div class="input-group mb-3">
                    <input v-model="form.cedula_ingreso" type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="CEDULA DEL COLABORADOR">
                  </div>
              </div>
              <div>
                  <div class="input-group mb-3">
  ...
  export default {  
      ...
      methods:{
          EnviarInterview(){
            ...
            {
                axios.post('/recruiter/requisicion/edit2', this.form).then((res) => {
