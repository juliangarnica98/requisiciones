...
<script>
    ...
    export default {
        ...
        methods:{
            getCharges(page=1){
                this.lista_charges={};
                axios.get('/generalistcomercial/getdatatiendas?page='+page)
                .then((res) => { 
                    // this.lista_charges={}  
            ...
            getTiendas(page=1){
                if (this.filtro_regional == "") {
                    ...
                    this.lista_charges={};
                    axios.get('/generalistcomercial/getdatatiendas2/'+this.filtro_regional+'?page='+page)
                    .then((res) => { 
                        // this.lista_charges={}  
                        this.lista_charges = Object.assign(res.data.tiendas, {});
                        this.regionales = Object.assign(res.data.regionals, {});
            ...
            deleteCharge(id){
                ...
                if (result.isConfirmed) {
                    axios.delete(`/generalistcomercial/deletetienda/${id}`)
                    .then((res) => {
            ...
            search(){
                if (this.form.buscar_tienda == '') {
                    ...
                    axios.post('/generalistcomercial/store/search',this.form)
                    .then((res) => {
                        this.lista_charges = {},
