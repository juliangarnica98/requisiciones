<template>
    <div class="page" id="page-content" >
        ...
        <div>
            ...
            <router-link class="btn btn-lili" to="/generalistcomercial/requisiciones" aria-expanded="false">
        ...
        <div class="" v-if="Object.keys(requisition).length >0">
            ...
            <div class="row d-flex justify-content-center mt-2 pt-1" >
                <!-- card para apertura de tienda -->
                <div class="col-md-8" v-if="requisition.comentarios">
                    <div class="card "  >
                        <div class="card-body">
                            <h4 class="text-center">
                                COMENTARIOS DE SELECCION
                            </h4>
                            <hr>
                            <h5 class="text-center">
                                {{ requisition.comentarios  }}
                            </h5>
...
export default {
    ...
    methods: {
        getUsers: function () {
            axios
                .get(
                    `/generalistcomercial/getrequisicion/${this.$route.params.area}/${this.$route.params.id}`
                )
                .then((res) => {
