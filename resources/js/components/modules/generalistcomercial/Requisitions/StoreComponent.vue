...
<script>
    export default{
        ...
        methods:{
            getData(){
                axios.get('/generalistcomercial/getdatarequisition')
                .then((res) => {
            ...
            createRequisition(){
                axios.post('/generalistcomercial/requisicion/store', this.form).then((res) => {
                this.$toast.success(res.data);
                this.$router.push('/generalistcomercial/requisiciones');
