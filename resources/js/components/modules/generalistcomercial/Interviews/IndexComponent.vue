                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-md-2 text-center">
                                            <div class="col-md-12" v-if="entrevista.status==1">
                                                <router-link class="link h4 text-white" :to="{name:'/generalistcomercial/entrevista',params:{ id: entrevista.id}}" aria-expanded="false" >
    ...
    export default {
        ...
        methods:{
            getRequisitions(page=1){
                axios.get('/generalistcomercial/getdatainterview?page='+page)
                .then((res) => { 
