                ...
                <div class="menu">
                    ...
                    <ul class="menu-links pt-5">
                        <li class="nav-link">
                            <router-link
                                class="router-link"
                                to="/generalistcomercial/dashboard"
                                aria-expanded="false"
                            >
                    ...
                    <ul class="menu-links">
                        <li class="nav-link">
                            <router-link
                                class="router-link"
                                to="/generalistcomercial/entrevistas"
                                aria-expanded="false"
                            >
                    ...
                    <ul class="menu-links">
                        <li class="nav-link">
                            <router-link
                                class="router-link"
                                to="/generalistcomercial/requisiciones"
                                aria-expanded="false"
                            >
                    ...
                    <ul class="menu-links">
                        <li class="nav-link">
                            <router-link class="router-link" to="/generalistcomercial/charges" aria-expanded="false" >
                    ...
                    <ul class="menu-links">
                        <li class="nav-link">
                            <router-link class="router-link" to="/generalistcomercial/tiendas" aria-expanded="false" >
